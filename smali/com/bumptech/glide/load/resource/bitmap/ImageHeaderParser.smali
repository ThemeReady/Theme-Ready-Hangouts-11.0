...
.method public constructor <init>(Ljava/io/InputStream;Laqo;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqo;

    .line 100
    new-instance v0, Lawk;

    invoke-direct {v0, p1}, Lawk;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawj;

    .line 101
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Laqo;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lawh;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Lawi;)I
    .locals 10
    ...
    .line 288
    invoke-virtual {p0, v1}, Lawi;->b(I)S
    ...
    .line 301
    :goto_0
    invoke-virtual {p0, v0}, Lawi;->a(Ljava/nio/ByteOrder;)V

    .line 303
    const/16 v0, 0xa

    invoke-virtual {p0, v0}, Lawi;->a(I)I
    ...
    .line 309
    invoke-virtual {p0, v3}, Lawi;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lawi;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lawi;->a(I)I
...
.method private d()I
    ...
    .line 246
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawj;

    invoke-interface {v1}, Lawj;->b()S
    ...
    .line 269
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawj;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lawj;->a(J)J
...
.method public b()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 116
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawj;

    invoke-interface {v0}, Lawj;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lawj;->a(J)J

    .line 129
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawj;

    invoke-interface {v0}, Lawj;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lawj;->a(J)J
...
.method public c()I
    ...
    .line 193
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqo;

    const-class v3, [B

    invoke-virtual {v0, v2, v3}, Laqo;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v0, v2}, Lawj;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqo;

    const-class v3, [B

    invoke-virtual {v2, v0, v3}, Laqo;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v0, v2}, Lawi;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lawi;)I
    :try_end_1

...
.field private objectParser:Lkid;
...
.method constructor <init>(Lcom/google/api/client/http/HttpTransport;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/api/client/http/HttpRequest;->sleeper:Lkig;
...
.method public execute()Lcom/google/api/client/http/HttpResponse;
    ...
    sget-object v5, Lkij;->a:Ljava/lang/String;
    ...
    invoke-direct {v4, v5, v9, v10, v11}, Lkhz;-><init>(Lkii;Ljava/util/logging/Logger;Ljava/util/logging/Level;I)V
    ...
    sget-object v19, Lkij;->a:Ljava/lang/String;
    ...
    sget-object v18, Lkij;->a:Ljava/lang/String;
    ...
    .line 958
    invoke-virtual {v15, v5}, Lcom/google/api/client/http/LowLevelHttpRequest;->setStreamingContent(Lkii;)V
    ...
    invoke-direct {v10, v4, v5}, Lcom/google/api/client/http/HttpEncodingStreamingContent;-><init>(Lkii;Lcom/google/api/client/http/HttpEncoding;)V

    .line 927
    if-eqz v12, :cond_17

    invoke-static {v10}, Lfxl;->a(Lkii;)J
    ...
    iget-object v3, v0, Lcom/google/api/client/http/HttpRequest;->sleeper:Lkig;

    invoke-interface {v3, v8, v9}, Lkig;->a(J)V
    :try_end_5
...
.method public final getParser()Lkid;
    .locals 1

    .prologue
    .line 691
    iget-object v0, p0, Lcom/google/api/client/http/HttpRequest;->objectParser:Lkid;
...
.method public getSleeper()Lkig;
    .locals 1

    .prologue
    .line 1160
    iget-object v0, p0, Lcom/google/api/client/http/HttpRequest;->sleeper:Lkig;
...
.method public setParser(Lkid;)Lcom/google/api/client/http/HttpRequest;
    .locals 0

    .prologue
    .line 681
    iput-object p1, p0, Lcom/google/api/client/http/HttpRequest;->objectParser:Lkid;
...
.method public setSleeper(Lkig;)Lcom/google/api/client/http/HttpRequest;
    .locals 1

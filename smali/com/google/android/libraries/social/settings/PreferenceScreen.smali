...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Ljyx;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private a(Landroid/os/Bundle;)V
    ...
    .line 169
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/libraries/social/settings/PreferenceScreen;->B()Ljzb;

    move-result-object v0

    invoke-virtual {v0, v4}, Ljzb;->a(Landroid/content/DialogInterface;)V
...
.method protected a(Landroid/os/Parcelable;)V
    ...
    .line 219
    :cond_0
    invoke-super {p0, p1}, Ljyx;->a(Landroid/os/Parcelable;)V
    ...
    .line 224
    invoke-virtual {p1}, Ljzh;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Ljyx;->a(Landroid/os/Parcelable;)V

    .line 225
    iget-boolean v0, p1, Ljzh;->a:Z

    if-eqz v0, :cond_1

    .line 226
    iget-object v0, p1, Ljzh;->b:Landroid/os/Bundle;
...
.method protected e()Landroid/os/Parcelable;
    ...
    .prologue
    .line 203
    invoke-super {p0}, Ljyx;->e()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Ljzh;-><init>(Landroid/os/Parcelable;)V

    .line 210
    const/4 v1, 0x1

    iput-boolean v1, v0, Ljzh;->a:Z
    ...
    iput-object v1, v0, Ljzh;->b:Landroid/os/Bundle;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {v0, p1}, Ljzb;->b(Landroid/content/DialogInterface;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 193
    invoke-virtual {v0, p0}, Ljyl;->a(Lcom/google/android/libraries/social/settings/PreferenceScreen;)V

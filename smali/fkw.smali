...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lfki;)V
    .locals 3
    ...
    .line 34
    iput-object p1, p0, Lfkw;->a:Landroid/content/Context;

    .line 35
    iput-object p4, p0, Lfkw;->b:Lfki;
    ...
    .line 41
    invoke-static {p2}, Lfmg;->a(Landroid/content/Context;)I

    move-result v2

    invoke-direct {v1, p2, v2}, Lflp;-><init>(Landroid/content/Context;I)V

    const/4 v2, 0x1

    invoke-direct {v0, p2, p3, v1, v2}, Lfls;-><init>(Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;Landroid/telecom/ConnectionRequest;Lflp;Z)V

    .line 43
    new-instance v1, Lfkd;

    invoke-direct {v1, v0}, Lfkd;-><init>(Lfls;)V

    iput-object v1, p0, Lfkw;->c:Lfkd;

    .line 44
    iget-object v0, p0, Lfkw;->c:Lfkd;
...
.method private b()Z
    ...
    .line 92
    invoke-virtual {v0}, Lfkd;->y()J

    move-result-wide v4

    iget-object v3, p0, Lfkw;->a:Landroid/content/Context;

    .line 93
    invoke-static {v3}, Lfki;->a(Landroid/content/Context;)J
    ...
    iget-object v3, p0, Lfkw;->c:Lfkd;

    .line 95
    invoke-virtual {v3}, Lfkd;->e()Landroid/telecom/ConnectionRequest;
    ...
    .line 2227
    :goto_4
    invoke-static {v5, v4, v3, v0}, Lfki;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public a()Lfkd;
    ...
    invoke-virtual {v0, v2, v1}, Lfki;->a(Landroid/telecom/ConnectionRequest;Z)Z
    ...
    .line 73
    iget-object v2, p0, Lfkw;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3}, Lfls;->c()Ljava/lang/String;

    move-result-object v3

    .line 73
    invoke-static {v2, v1, v3, v0}, Lfxl;->a(Landroid/content/Context;ILjava/lang/String;I)V
    ...
    .line 1160
    :cond_1
    iget-object v0, p0, Lfkw;->a:Landroid/content/Context;

    const-string v2, "babel_spam_caller_id"

    const-string v4, "+14082560700"

    invoke-static {v0, v2, v4}, Lfxl;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1164
    iget-object v4, p0, Lfkw;->c:Lfkd;

    invoke-virtual {v4}, Lfkd;->h()Lflp;

    move-result-object v4

    iget-object v5, p0, Lfkw;->a:Landroid/content/Context;
    ...
    .line 1165
    invoke-static {v2, v0}, Lfxl;->f(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 1168
    invoke-static {v2}, Lfxl;->H(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1172
    :cond_2
    invoke-static {v2, v0}, Lfxl;->g(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 2118
    invoke-virtual {v4}, Lfkd;->e()Landroid/telecom/ConnectionRequest;
    ...
    invoke-static {v0, v4, v1}, Lfsw;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Lfkd;->a(Lfjp;)V

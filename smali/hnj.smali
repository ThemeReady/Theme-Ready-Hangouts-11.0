...
# direct methods
.method constructor <init>(Lhng;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2

    iput-object p1, p0, Lhnj;->a:Lhng;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .prologue
    .line 0
    invoke-direct {p0, p1, p2}, Lhnj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Lhnj;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    iget-object v1, p0, Lhnj;->a:Lhng;

    invoke-virtual {v1}, Lhng;->s()Lhny;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lhnj;->a:Lhng;

    invoke-virtual {v2}, Lhng;->s()Lhny;
    ...
    invoke-virtual {v2, v3, p2, v0}, Lhoa;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v0, p0, Lhnj;->a:Lhng;

    invoke-static {v0}, Lhng;->a(Lhng;)Lhmy;

    move-result-object v0

    invoke-static {}, Lhnf;->G()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lhmy;->a(J)Z
    ...
    invoke-static {v0}, Lhng;->b(Lhng;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lhnj;->a:Lhng;

    invoke-virtual {v1}, Lhng;->m()Landroid/content/Context;
    ...
    invoke-static {v1}, Lhng;->a(Lhng;)Lhmy;
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lhnj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 2000
    sget-object v11, Lhng;->a:Ljava/util/Map;
    ...
    .line 0
    invoke-direct/range {v6 .. v11}, Lhnj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V

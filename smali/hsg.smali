...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhsg;->o:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lhsf;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p7}, Lhsb;-><init>(Landroid/content/Context;Lhsf;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
...
.method private e()Ljava/lang/String;
    ...
    iget-object v0, p0, Lhsg;->a:Landroid/content/Context;
    ...
    sget-object v2, Lhsg;->o:[Ljava/lang/String;

    invoke-direct {p0}, Lhsg;->f()Ljava/lang/String;
...
.method private f()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lhsg;->a()Lcom/google/android/gms/common/data/DataHolder;
    ...
    invoke-direct {v2, v0}, Lhse;-><init>(Lcom/google/android/gms/common/data/DataHolder;)V

    const/4 v0, 0x1

    :goto_0
    invoke-virtual {v2}, Lhse;->c()Z
    ...
    invoke-virtual {v2, v3}, Lhse;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method protected a(Lhse;Lhse;Landroid/database/Cursor;)Lhrt;
    ...
    iget-object v1, p0, Lhsg;->i:Lhtt;

    const-string v2, "people-map start"

    invoke-virtual {v1, v2}, Lhtt;->a(Ljava/lang/String;)V

    invoke-static {p1, v4}, Lhsg;->a(Lhse;Ljava/util/HashMap;)V
    ...
    new-instance v9, Lhtv;

    invoke-direct {v9}, Lhtv;-><init>()V

    new-instance v10, Lhsu;

    invoke-direct {v10}, Lhsu;-><init>()V

    new-instance v8, Ljava/util/HashMap;

    invoke-direct {v8}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {p0, p2, v8}, Lhsg;->b(Lhse;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p3, v9, v10, v8}, Lhsg;->a(Landroid/database/Cursor;Lhtv;Lhsu;Ljava/util/HashMap;)I

    move-result v1

    iget-object v2, p0, Lhsg;->i:Lhtt;

    const-string v3, "contact-map finish"

    invoke-virtual {v2, v3}, Lhtt;->a(Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Lfxl;->i(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, p0, Lhsg;->i:Lhtt;
    ...
    invoke-virtual {p0, v2, v1}, Lhsg;->a(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p1, v2}, Lhse;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v5, v1}, Lhsv;->a(I)V

    invoke-virtual {v7, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v2, :cond_3

    invoke-virtual {v9, v2}, Lhtv;->a(Ljava/lang/String;)I
    ...
    invoke-virtual {v10, v1}, Lhsu;->a(I)I
    ...
    invoke-virtual {v6, v1}, Lhsv;->a(I)V
    ...
    :cond_c
    invoke-virtual {v6, v9, v2}, Lhsv;->a(Lhtv;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v1, v0}, Lhsu;->a(II)Ljava/lang/String;
    ...
    iget-object v3, p0, Lhsg;->a:Landroid/content/Context;
    ...
    iget-object v10, p0, Lhsg;->f:Landroid/os/Bundle;
...
.method protected c()Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lhsg;->e()Ljava/lang/String;
    ...
    sget-object v0, Lhrz;->a:Landroid/net/Uri;
    ...
    invoke-virtual {v3, v2}, Lhts;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3, v0, v1}, Lhry;->a(Lhts;ZLandroid/content/Context;)V

    invoke-static {v3}, Lhry;->a(Lhts;)V

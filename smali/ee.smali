...
.method public constructor <init>(Landroid/view/View;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;Landroid/view/View;)V
    ...
    iput-object p3, p0, Lee;->c:Ljava/util/ArrayList;

    iput-object p4, p0, Lee;->d:Landroid/transition/Transition;

    iput-object p5, p0, Lee;->e:Ljava/util/ArrayList;

    iput-object p6, p0, Lee;->f:Landroid/transition/Transition;

    iput-object p7, p0, Lee;->g:Ljava/util/ArrayList;

    iput-object p8, p0, Lee;->h:Ljava/util/Map;

    iput-object p9, p0, Lee;->i:Ljava/util/ArrayList;

    iput-object p10, p0, Lee;->j:Landroid/transition/Transition;

    iput-object p11, p0, Lee;->k:Landroid/view/View;
...
.method public onPreDraw()Z
    ...
    iget-object v1, p0, Lee;->c:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lee;->d:Landroid/transition/Transition;

    iget-object v3, p0, Lee;->e:Ljava/util/ArrayList;

    invoke-static {v0, v1, v3, v2}, Lfxl;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V

    .line 398
    iget-object v0, p0, Lee;->b:Landroid/transition/Transition;

    iget-object v1, p0, Lee;->f:Landroid/transition/Transition;

    iget-object v3, p0, Lee;->g:Ljava/util/ArrayList;

    invoke-static {v0, v1, v3, v2}, Lfxl;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V

    .line 401
    :cond_0
    iget-object v0, p0, Lee;->d:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Lee;->e:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lee;->c:Ljava/util/ArrayList;
    ...
    .line 407
    :cond_1
    iget-object v0, p0, Lee;->f:Landroid/transition/Transition;
    ...
    .line 410
    :cond_2
    iget-object v0, p0, Lee;->h:Ljava/util/Map;
    ...
    .line 415
    :cond_3
    iget-object v0, p0, Lee;->i:Ljava/util/ArrayList;
    ...
    .line 417
    iget-object v4, p0, Lee;->j:Landroid/transition/Transition;
    ...
    .line 419
    :cond_4
    iget-object v0, p0, Lee;->j:Landroid/transition/Transition;

    iget-object v1, p0, Lee;->k:Landroid/view/View;

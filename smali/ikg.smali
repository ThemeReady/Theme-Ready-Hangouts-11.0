...
.method public constructor <init>(Lcom/google/android/libraries/hangouts/video/internal/DecoderManager;Likd;)V
    ...
    .prologue
    .line 62
    invoke-direct {p0, p1, p2}, Lcom/google/android/libraries/hangouts/video/internal/MediaCodecDecoder;-><init>(Lcom/google/android/libraries/hangouts/video/internal/DecoderManager;Likd;)V

    .line 52
    new-instance v0, Likh;

    .line 1023
    invoke-direct {v0, p0}, Likh;-><init>(Likg;)V

    .line 52
    iput-object v0, p0, Likg;->g:Likh;
    ...
    iput-object v0, p0, Likg;->f:Ljava/util/concurrent/ConcurrentLinkedQueue;
...
.method protected a(I)Ljava/nio/ByteBuffer;
    ...
    .prologue
    .line 79
    invoke-virtual {p0}, Likg;->d()Landroid/media/MediaCodec;
...
.method protected a(Landroid/media/MediaCodec;)V
    ...
    .prologue
    .line 67
    iget-object v0, p0, Likg;->g:Likh;

    invoke-virtual {p1, v0}, Landroid/media/MediaCodec;->setCallback(Landroid/media/MediaCodec$Callback;)V

    .line 68
    iget-object v0, p0, Likg;->f:Ljava/util/concurrent/ConcurrentLinkedQueue;
